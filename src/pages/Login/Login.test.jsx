...
describe("Login component", () => {
  ...
  it("should render title and register link", () => {
    render(<Login />);
    expect(screen.getByTestId("labelConnexion")).toBeInTheDocument();
    expect(screen.getByTestId("linkSignUp")).toBeInTheDocument();
  });
  ...
  it("should render login form and handle successful login", async () => {
    ...
    const emailInput = screen.getByTestId("inputMail");
